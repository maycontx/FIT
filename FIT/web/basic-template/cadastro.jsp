<div id="finish-register">    
    <div class="page-header">
        <h1>Conclusão de cadastro<small> só mais alguns instantes...</small></h1>
    </div>
    <div class="btn-group" data-toggle="buttons">
        <label class="btn btn-primary img-radio">
            <img src="img/Nutricionista.jpg">                
            <input type="radio" name="tipo" id="Atleta" value="Atleta" autocomplete="off">
        ...
        <label class="btn btn-primary img-radio">
            <img src="img/Nutricionista.jpg">
            <input type="radio" name="tipo" id="Personal" value="Personal" autocomplete="off">
        ...
        <div class="btn btn-primary img-radio">  
            <img src="img/Nutricionista.jpg" />
            <input type="radio" name="tipo" id="Nutricionista" value="Nutricionista" autocomplete="off">
